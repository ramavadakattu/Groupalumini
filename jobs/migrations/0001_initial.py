...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JobComment'
        db.create_table('jobs_jobcomment', (
            ('id', orm['jobs.JobComment:id']),
            ('job', orm['jobs.JobComment:job']),
            ('text', orm['jobs.JobComment:text']),
            ('postedby', orm['jobs.JobComment:postedby']),
            ('createddate', orm['jobs.JobComment:createddate']),
            ('updateddate', orm['jobs.JobComment:updateddate']),
        ))
        db.send_create_signal('jobs', ['JobComment'])
        
        # Adding model 'Job'
        db.create_table('jobs_job', (
            ('id', orm['jobs.Job:id']),
            ('postedby', orm['jobs.Job:postedby']),
            ('institute', orm['jobs.Job:institute']),
            ('title', orm['jobs.Job:title']),
            ('description', orm['jobs.Job:description']),
            ('location', orm['jobs.Job:location']),
            ('createddate', orm['jobs.Job:createddate']),
            ('updateddate', orm['jobs.Job:updateddate']),
            ('sendemail', orm['jobs.Job:sendemail']),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'JobComment'
        db.delete_table('jobs_jobcomment')
