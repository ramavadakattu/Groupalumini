...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.institute'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['institution.Institution'], null=True, blank=True))
        db.alter_column('jobs_job', 'institute_id', orm['jobs.job:institute'])
        
        # Changing field 'Job.postedby'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['auth.User'], null=True, blank=True))
        db.alter_column('jobs_job', 'postedby_id', orm['jobs.job:postedby'])
        
        # Changing field 'Job.location'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('jobs_job', 'location', orm['jobs.job:location'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Job.institute'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['institution.Institution']))
        db.alter_column('jobs_job', 'institute_id', orm['jobs.job:institute'])
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['institution.Institution']", 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'postedby': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
