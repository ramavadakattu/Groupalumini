...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('institution_userprofile', 'activation_key', orm['institution.userprofile:activation_key'])
        
        # Changing field 'Student.whatiamdoing'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('institution_student', 'whatiamdoing', orm['institution.student:whatiamdoing'])
