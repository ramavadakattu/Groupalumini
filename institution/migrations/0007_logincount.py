...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.logincount'
        db.add_column('institution_userprofile', 'logincount', orm['institution.userprofile:logincount'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.logincount'
        db.delete_column('institution_userprofile', 'logincount')
