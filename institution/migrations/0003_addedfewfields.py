...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('institution_userprofile', 'activation_key', orm['institution.userprofile:activation_key'])
        
        # Adding field 'UserProfile.emailverified'
        db.add_column('institution_userprofile', 'emailverified', orm['institution.userprofile:emailverified'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('institution_userprofile', 'activation_key')
        
        # Deleting field 'UserProfile.emailverified'
        db.delete_column('institution_userprofile', 'emailverified')
