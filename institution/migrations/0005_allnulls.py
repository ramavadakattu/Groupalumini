...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacultyInstitute.designation'
        # (to signature: django.db.models.fields.CharField(max_length=200, null=True, blank=True))
        db.alter_column('institution_facultyinstitute', 'designation', orm['institution.facultyinstitute:designation'])
        
        # Changing field 'FacultyInstitute.department'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['institution.Department'], null=True, blank=True))
        db.alter_column('institution_facultyinstitute', 'department_id', orm['institution.facultyinstitute:department'])
        
        # Changing field 'Student.industry'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['statistics.Industry'], null=True, blank=True))
        db.alter_column('institution_student', 'industry_id', orm['institution.student:industry'])
        
        # Changing field 'Student.market'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['statistics.Market'], null=True, blank=True))
        db.alter_column('institution_student', 'market_id', orm['institution.student:market'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FacultyInstitute.department'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['institution.Department']))
        db.alter_column('institution_facultyinstitute', 'department_id', orm['institution.facultyinstitute:department'])
        
        # Changing field 'Student.industry'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['statistics.Industry']))
        db.alter_column('institution_student', 'industry_id', orm['institution.student:industry'])
        
        # Changing field 'Student.market'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['statistics.Market']))
        db.alter_column('institution_student', 'market_id', orm['institution.student:market'])
