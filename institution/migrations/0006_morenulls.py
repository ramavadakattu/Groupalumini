...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.personalsite'
        # (to signature: django.db.models.fields.URLField(max_length=200, null=True, blank=True))
        db.alter_column('institution_userprofile', 'personalsite', orm['institution.userprofile:personalsite'])
