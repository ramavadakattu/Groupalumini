...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.profilepercent'
        db.add_column('institution_userprofile', 'profilepercent', orm['institution.userprofile:profilepercent'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.profilepercent'
        db.delete_column('institution_userprofile', 'profilepercent')
