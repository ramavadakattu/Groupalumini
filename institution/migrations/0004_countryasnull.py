...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['location.Country'], null=True, blank=True))
        db.alter_column('institution_userprofile', 'country_id', orm['institution.userprofile:country'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.country'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['location.Country']))
        db.alter_column('institution_userprofile', 'country_id', orm['institution.userprofile:country'])
